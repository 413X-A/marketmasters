...
trends:[],
customerSegments:["normal","trend","sparfuchs"]
};
...
// KI beeinflusst Nachfrage
demand *= getCompetitorFactor(p);
...
// ================= KI Logik =================
function getCompetitorFactor(p){
let factor=1.0;
game.competitors.forEach(c=>{
// zufällige Preisanpassung durch Konkurrenz
if(Math.random()<0.3){
factor *= c.factor;
}
});
