...
const game = {
  ...
  products:[
    {id:1,name:"Wasser", buy:0.3, price:1, stock:50, quality:1, unlocked:true},
    {id:2,name:"Brot", buy:0.5, price:1.5, stock:40, quality:1, unlocked:true},
    {id:3,name:"Kaffee", buy:1, price:3, stock:0, quality:2, unlocked:false},
    {id:4,name:"Premium Snack", buy:2, price:5, stock:0, quality:3, unlocked:false},
    {id:5,name:"Luxus Box", buy:5, price:12, stock:0, quality:4, unlocked:false}
  ]
};
...
function nextDay(){
  ...
  if(complaints>0){
    ...
    logEvent("⚠️ "+complaints+" Beschwerden wegen Preisen!");
  }

  // Marktanteil
  game.marketShare+=soldTotal*0.01;
  game.marketShare=Math.min(100,game.marketShare);
...
function buyUpgrade(type){
  ...
  game.money-=cost;
  game.upgrades[type]++;
  logEvent("⬆️ Upgrade "+type+" auf Stufe "+game.upgrades[type]);
  render();
}
...
function logEvent(t){
  ...
  e.innerHTML="<div>"+t+"</div>"+e.innerHTML;
}
